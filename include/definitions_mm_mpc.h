...
#define NMO         1   /* Number of obstacles. */
#define SMO         7   /* Size of obstacle data. */
 ...
 * NC + NX + NW + NO * SO + NMO * SMO + NPLANES * SPLANES + NINFPLA * SINFPLA*/
#define NP          265
#define NPF         267  /* Number of forces parameters. NP + 2 */
