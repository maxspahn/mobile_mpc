% simplempc - a fast solver generated by FORCES PRO v4.0.0
%
...
%
%   [OUTPUT, EXITFLAG] = simplempc(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = simplempc(PARAMS) returns 
