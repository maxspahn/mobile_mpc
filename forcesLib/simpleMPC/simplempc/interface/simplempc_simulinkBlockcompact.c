...
#define S_FUNCTION_NAME simplempc_simulinkBlockcompact
...
typedef simplempcinterface_float simplempcnmpc_float;

extern void simplempc_casadi2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration);
