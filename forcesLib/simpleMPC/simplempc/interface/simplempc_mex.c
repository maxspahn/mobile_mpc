...
extern void simplempc_casadi2forces(simplempc_float *x, simplempc_float *y, simplempc_float *l, simplempc_float *p, simplempc_float *f, simplempc_float *nabla_f, simplempc_float *c, simplempc_float *nabla_c, simplempc_float *h, simplempc_float *nabla_h, simplempc_float *hess, solver_int32_default stage, solver_int32_default iteration);
simplempc_extfunc pt2function_simplempc = &simplempc_casadi2forces;


/* Some memory for mex-function */
static simplempc_params params;
static simplempc_output output;
static simplempc_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help simplempc_mex' for details.");
    }    
	if (nlhs > 3) 
	{
	...
	/* call solver */
	exitflag = simplempc_solve(&params, &output, &info, fp, pt2function_simplempc);
