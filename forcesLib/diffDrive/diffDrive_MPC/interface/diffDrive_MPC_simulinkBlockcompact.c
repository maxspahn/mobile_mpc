...
#define S_FUNCTION_NAME diffDrive_MPC_simulinkBlockcompact
...
#include "../include/diffDrive_MPC.h" 
...
typedef diffDrive_MPCinterface_float diffDrive_MPCnmpc_float;

extern void diffDrive_MPC_casadi2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration);
diffDrive_MPC_extfunc pt2function_diffDrive_MPC = &diffDrive_MPC_casadi2forces;
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 1 */
    ssSetInputPortMatrixDimensions(S,  1, 75, 1);
    ssSetInputPortDataType(S, 1, SS_DOUBLE);
    ssSetInputPortComplexSignal(S, 1, COMPLEX_NO); /* no complex signals suppported */
    ssSetInputPortDirectFeedThrough(S, 1, 1); /* Feedthrough enabled */
    ssSetInputPortRequiredContiguous(S, 1, 1); /*direct input signal access*/	
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 150, 1);
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 75, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Solver data */
	diffDrive_MPC_params params;
	diffDrive_MPC_output output;
	diffDrive_MPC_info info;	
    ...
    #if SET_PRINTLEVEL_diffDrive_MPC > 0
	...
	/* Call solver */
	exitflag = diffDrive_MPC_solve(&params, &output, &info, fp , pt2function_diffDrive_MPC);
