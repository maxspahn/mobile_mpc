% diffDrive_MPC - a fast solver generated by FORCES PRO v3.0.1
%
%   OUTPUT = diffDrive_MPC(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = diffDrive_MPC(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = diffDrive_MPC(PARAMS) returns 
