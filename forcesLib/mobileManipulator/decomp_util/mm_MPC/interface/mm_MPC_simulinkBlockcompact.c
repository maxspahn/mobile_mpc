...
#define S_FUNCTION_NAME mm_MPC_simulinkBlockcompact
...
typedef mm_MPCinterface_float mm_MPCnmpc_float;

extern void mm_MPC_casadi2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration);
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 5200, 1);
