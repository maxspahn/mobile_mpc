  ...
  frequency_(5.0)
{
  ...
  subConstraints_base1_ = nh_.subscribe("/mpc/constraints/base1", 10, &MpcPlanner::constraints_base1_cb, this);
  subConstraints_base2_ = nh_.subscribe("/mpc/constraints/base2", 10, &MpcPlanner::constraints_base2_cb, this);
  subConstraints_mid_ = nh_.subscribe("/mpc/constraints/mid", 10, &MpcPlanner::constraints_mid_cb, this);
  subConstraints_ee_ = nh_.subscribe("/mpc/constraints/ee", 10, &MpcPlanner::constraints_ee_cb, this);
  subGlobalPath_ = nh_.subscribe("/mpc/globalPath/spline", 10, &MpcPlanner::globalPath_cb, this);
  pubPredTraj_ = nh_.advertise<nav_msgs::Path>("/mpc/predicted_trajectory", 10);
